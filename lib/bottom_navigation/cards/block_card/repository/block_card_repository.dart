...
class BlockCardRepository {
  final HttpService httpService;
  BlockCardRepository({required this.httpService});

  Future<BlockCardModel> blockCard() async {
    final path = "${EndPointURL.baseURL}/api/blockcard";
    try {
      ...
      if (response.statusCode! >= 200 && response.statusCode! <= 300) {
        ...
        return BlockCardModel.fromJson(response.data);
      } else {
