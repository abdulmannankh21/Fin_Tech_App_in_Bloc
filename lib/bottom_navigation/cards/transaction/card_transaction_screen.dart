...
class CardTransactionScreen extends StatefulWidget {
  final cardid;
  const CardTransactionScreen({Key? key, required this.cardid}) : super(key: key);
...
class _CardTransactionScreenState extends State<CardTransactionScreen> {
  ...
  void initState(){
    super.initState();
    context.read<CardTransactionCubit>().gteCardTransaction(widget.cardid);
  }
      ...
      body: Container(
        ...
        child: BlocConsumer<CardTransactionCubit, CardTransactionState>(
          ...
          builder: (context, state) {
            if (state is CardTransactionLoadingState) {
              return Container(
            ...
            if (state is CardTransactionSuccesstate) {
              if (state.model.data != null &&
                  state.model.data?.entry != null &&
                  state.model.data!.entry!.isNotEmpty) {
                return Column(
                  children: [
                    SizedBox(height: 40),
                    Container(
                      ...
                      child: TextFormField(
                        ...
                        onEditingComplete: (){
                          context
                              .read<CardTransactionCubit>()
                              .searchTransaction(
                            state.model.data!.entry,
                            _controller.text,
                          );
                        },
                    ...
                    Container(
                        ...
                        child: SingleChildScrollView(
                            ...
                            ListView.builder(
                              shrinkWrap: true,
                              physics: const ScrollPhysics(),
                              itemCount: state.model.data?.entry?.length,
                              itemBuilder: (BuildContext context, int index) {
                                final _model = state.model.data!.entry?[index];
                                return Padding(
                                  ...
                                  child: TransactionBuilder(
                                              ...
                                              Column(
                                                ...
                                                children: <Widget>[
                                                    ...
                                                    children: [
                                                      ListTile(
                                                        ...
                                                        trailing: Container(
                                                          ...
                                                          child: Text(
                                                            """${_model?.transactionAmount!.currency} ${processAmount(_model!.transactionAmount!.amount)} """,
                                                  ...
                                                  BottomContain(
                                                    ...
                                                    subTitle: processTimeStamp(_model.processedTimestamp),
                                                  ),
                                                  BottomContain(
                                                    icon: Icons.note,
                                                    title: "type".tr,
                                                    subTitle: _model.transactionId!.type,
                                                    maxLines: 2,
                                                  ),
                                                  BottomContain(
                                                    icon: Icons.note,
                                                  ...
                                                  BottomContain(
                                                    ...
                                                    icon: Icons.date_range,
                                                    subTitle: _model.transactionId!.id,
                                                  ),
                                                  BottomContain(
                                                    title: "name".tr,
                                                    icon: Icons.date_range,
                                                    subTitle: getTitle(_model),
                                                  ),
                                    ...
                                    leadingText: _model!.transactionId!.type[0],
                                    title: getTitle(_model),
                                    description: processTimeStamp(_model.processedTimestamp),
                                    amount:
                                    """${_model.transactionAmount!.currency} ${processAmount(_model.transactionAmount!.amount)} """,
                                  ),
                                );
              ...
              if (state.allTransaction != null &&
                  ...
                  state.allTransaction!.isNotEmpty) {
                return Column(
                  children: [
                    SizedBox(height: 40),
            Container(
                                        ...
                                        Column(
                                          ...
                                          children: <Widget>[
                                            BottomContain(
                                              ...
                                              subTitle: """${_model?.transactionAmount!.currency} ${processAmount(_model!.transactionAmount!.amount)} """,
                                            ),
                                            BottomContain(
                                              title: "date".tr,
                                              icon: Icons.date_range,
