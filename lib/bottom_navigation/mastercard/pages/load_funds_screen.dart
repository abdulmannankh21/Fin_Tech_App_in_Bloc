...
class MasterCardLoadFunds extends StatefulWidget {



  @override
  State<MasterCardLoadFunds> createState() => _MasterCardLoadFundsState();
}

class _MasterCardLoadFundsState extends State<MasterCardLoadFunds> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BlocConsumer<MasterCardLoadFundCubit, MasterCardLoadFundState>(
        listener: (context, state) {
          if(state is MasterCardLoadFundSuccessState){
            state.model.message.showSnackBar(context);
          }else if(state is MasterCardLoadFundErrorState){
            'Error Occurred'.showSnackBar(context);
          }
        },
        builder: (context, state) {
          if (state is MasterCardLoadFundLoadingState) {
                    ...
                    child: GestureDetector(
                        onTap: () {
                          if(_amountController.text.isEmpty){
                            ...
                            context.read<MasterCardLoadFundCubit>().loadFunds(
