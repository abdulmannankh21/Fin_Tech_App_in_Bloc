                          ...
                          Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                const Spacer(),
                                state.model.transactions != null ?TextButton(
                                  onPressed: () {
                                    Navigator.of(context)
                                        .push(MaterialPageRoute(builder:  (context) => HomeTransactionScreen()));
                          ...
                          Container(
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              return state.model.transactions?.length == null
                                ...
                                leadingText: state.model.transactions![index].payment_status![0],
                                title: state.model.transactions![index].description!,
                                description: state.model.transactions![index].created_at!,
                                amount:
