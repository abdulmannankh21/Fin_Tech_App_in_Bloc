...
class _$_CreateWalletModel implements _CreateWalletModel {
  const _$_CreateWalletModel(this.status, this.code, this.message, this.data);
  ...
  @override
  String toString() {
    return 'CreateWalletModel(status: $status, code: $code, message: $message, data: $data)';
  }
...
abstract class _CreateWalletModel implements CreateWalletModel {
  const factory _CreateWalletModel(
          String? status, int? code, String? message, Data? data) =
